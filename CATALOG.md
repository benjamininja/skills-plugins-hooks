...
| **frontend-design** | execute | frontend | [anthropics/claude-code](https://github.com/anthropics/claude-code) | Create distinctive, production-grade frontend interfaces with high design quality. |
